...
# base.dir = "/groups/umcg-griac/tmp02/projects/AndyLan/ATLANTIS_eQTM/04_DMR_eQTM_data_prep/"
# output.dir <- "/groups/umcg-griac/tmp02/projects/AndyLan/ATLANTIS_eQTM/05_DMR_eQTM_results/"
# 
...
# # #### Asthma vs healthy ####
# # Genotype file name
# # SNP_file_name = paste(base.dir, "DMR_eQTM_mval_AsthmaVsHealthy.csv", sep="");
# # snps_location_file_name = paste(base.dir, "DMR_pos_AsthmaVsHealthy.csv", sep="");
# #
...
# #### Th2-high vs healthy ####
# # Genotype file name
# # SNP_file_name = paste(base.dir, "DMR_eQTM_mval_Th2HighvsHealthy_allSamples.csv", sep="");
# # snps_location_file_name = paste(base.dir, "DMR_pos_Th2HighvsHealthy.csv", sep="");
# #
# # # Gene expression file name
...
# #### Th2-low vs healthy ####
# # Genotype file name
# # SNP_file_name = paste(base.dir, "DMR_eQTM_mval_Th2LowvsHealthy_allSamples.csv", sep="");
# # snps_location_file_name = paste(base.dir, "DMR_pos_Th2LowvsHealthy.csv", sep="");
# #
# # # Gene expression file name
# # expression_file_name = paste(base.dir, "normalized_geneExpressionData_eQTM_Th2HighLowUndeterm_samples.csv", sep="");
# # gene_location_file_name = paste(base.dir, "geneLocation.csv", sep="");
...
# # #### Th2-high vs Th2-low ####
# # Genotype file name
# SNP_file_name = paste(base.dir, "DMR_eQTM_mval_Th2HighvsTh2Low_allSamples.csv", sep="");
# snps_location_file_name = paste(base.dir, "DMR_pos_Th2HighvsTh2Low.csv", sep="");
# 
# # Gene expression file name
# expression_file_name = paste(base.dir, "normalized_geneExpressionData_eQTM_Th2HighLowUndeterm_samples.csv", sep="");
# gene_location_file_name = paste(base.dir, "geneLocation.csv", sep="");
...
# write.csv(finaltable_sig, file = file.path(output.dir, "final_genomewideDMR_eQTMS_Th2HighvsTh2Low_allSamples.csv"))
# 
# save.image(file = file.path(output.dir, "toDMR_EQTM_Th2HighvsTh2Low_allSamples.rdata")) #ALL DATA UP TO HERE
# quit()
...
me$cis$eqtls %>%
  readr::write_csv(
    file.path(output.dir, "all-after-matrixeqtl_AsthmaVsHealthy_allSamples.csv")
  )
...
#SAVE ALL EQTMs
write.csv(finaltable, file = file.path(output.dir, "all_genomewideEQTMS_AsthmaVsHealthy_allSamples.csv"))

##SAVE ALL SIGNIFICANT EQTMS WITH MULTIPLE TESTING CORRECTION
finaltable_sig <- finaltable[which(finaltable$finalFDR<0.05),]
finaltable_sig <- finaltable_sig[order(finaltable_sig$finalFDR),]
write.csv(finaltable_sig, file = file.path(output.dir, "final_genomewideDMR_eQTMS_AsthmaVsHealthy_allSamples.csv"))

save.image(file = file.path(output.dir, "toDMR_EQTM_AsthmaVsHealthy_allSamples.rdata")) #ALL DATA UP TO HERE
...
me$cis$eqtls %>%
  readr::write_csv(
    file.path(output.dir, "all-after-matrixeqtl_Th2HighvsHealthy_allSamples.csv")
  )
...
#SAVE ALL EQTMs
write.csv(finaltable, file = file.path(output.dir, "all_genomewideEQTMS_Th2HighvsHealthy_allSamples.csv"))

##SAVE ALL SIGNIFICANT EQTMS WITH MULTIPLE TESTING CORRECTION
finaltable_sig <- finaltable[which(finaltable$finalFDR<0.05),]
finaltable_sig <- finaltable_sig[order(finaltable_sig$finalFDR),]
write.csv(finaltable_sig, file = file.path(output.dir, "final_genomewideDMR_eQTMS_Th2HighvsHealthy_allSamples.csv"))

save.image(file = file.path(output.dir, "toDMR_EQTM_Th2HighvsHealthy_allSamples.rdata")) #ALL DATA UP TO HERE
...
me$cis$eqtls %>%
  readr::write_csv(
    file.path(output.dir, "all-after-matrixeqtl_Th2LowvsHealthy_allSamples.csv")
  )
...
#SAVE ALL EQTMs
write.csv(finaltable, file = file.path(output.dir, "all_genomewideEQTMS_Th2LowvsHealthy_allSamples.csv"))

##SAVE ALL SIGNIFICANT EQTMS WITH MULTIPLE TESTING CORRECTION
finaltable_sig <- finaltable[which(finaltable$finalFDR<0.05),]
finaltable_sig <- finaltable_sig[order(finaltable_sig$finalFDR),]
write.csv(finaltable_sig, file = file.path(output.dir, "final_genomewideDMR_eQTMS_Th2LowvsHealthy_allSamples.csv"))

save.image(file = file.path(output.dir, "toDMR_EQTM_Th2LowvsHealthy_allSamples.rdata")) #ALL DATA UP TO HERE
